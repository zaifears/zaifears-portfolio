...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      <header className="bg-linear-to-r from-blue-700 to-blue-900 sticky top-0 z-50 shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="bg-linear-to-br from-green-500 to-emerald-600 p-8 rounded-3xl shadow-2xl text-white">
              ...
              <div className="space-y-5 mb-6">
                <div className="flex items-start gap-4 bg-white rounded-2xl p-4 shadow-md">
                  <Leaf className="h-7 w-7 shrink-0 mt-1 text-green-600" />
                  <div>
                ...
                <div className="flex items-start gap-4 bg-white rounded-2xl p-4 shadow-md">
                  <Droplet className="h-7 w-7 shrink-0 mt-1 text-blue-500" />
                  <div>
                ...
                <div className="flex items-start gap-4 bg-white rounded-2xl p-4 shadow-md">
                  <Trees className="h-7 w-7 shrink-0 mt-1 text-green-800" />
                  <div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-3xl shadow-2xl border-2 border-gray-100">
              ...
              <h1 className="text-4xl md:text-5xl font-black bg-linear-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-4">
              ...
              {/* --- (Retained Green for Sustainability Theme) --- */}
              <div className="mb-8 p-5 bg-linear-to-r from-green-50 to-emerald-50 border-2 border-green-400 rounded-2xl">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-6 gap-3">
                  ...
                  {sizes.map((size) => (
                    <button key={size} onClick={() => setSelectedSize(size)} className={`py-4 rounded-2xl font-black text-lg transition-all ${selectedSize === size ? 'bg-linear-to-br from-blue-600 to-blue-700 text-white shadow-2xl scale-110' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 hover:scale-105'}`}>
                      {size}
                    </button>
                  ))}
                </div>
              ...
              <div className="flex gap-4 mb-8">
                ...
                <button disabled={!selectedSize} className={`flex-1 py-5 rounded-2xl font-black text-xl transition-all flex items-center justify-center gap-3 shadow-xl ${selectedSize ? 'bg-linear-to-r from-blue-600 to-blue-700 text-white hover:shadow-2xl hover:scale-105' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`}>
              ...
              <button className="w-full py-4 bg-linear-to-r from-gray-200 to-gray-300 text-gray-900 font-black rounded-2xl hover:from-gray-300 hover:to-gray-400 transition-all mb-8 shadow-lg text-lg">
                FIND IN STORE
              </button>
              ...
              <div className="space-y-4">
                ...
                <div className="border-4 border-blue-500 rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <button onClick={() => setShowSizeGuide(!showSizeGuide)} className="w-full px-6 py-5 flex items-center justify-between bg-linear-to-r from-blue-700 to-blue-800 text-white hover:from-blue-800 hover:to-blue-700 transition-all">
                ...
                <div className="border-4 border-blue-500 rounded-2xl overflow-hidden shadow-lg">
                  <button onClick={() => setShowProductCode(!showProductCode)} className="w-full px-6 py-5 flex items-center justify-between bg-linear-to-r from-blue-700 to-blue-800 text-white hover:from-blue-800 hover:to-blue-700 transition-all">
                ...
                <div className="border-4 border-blue-500 rounded-2xl overflow-hidden shadow-lg">
                  <button onClick={() => setShowDescription(!showDescription)} className="w-full px-6 py-5 flex items-center justify-between bg-linear-to-r from-blue-700 to-blue-800 text-white hover:from-blue-800 hover:to-blue-700 transition-all">
                ...
                <div className="border-4 border-blue-500 rounded-2xl overflow-hidden shadow-lg">
                  <button onClick={() => setShowReviews(!showReviews)} className="w-full px-6 py-5 flex items-center justify-between bg-linear-to-r from-blue-700 to-blue-800 text-white hover:from-blue-800 hover:to-blue-700 transition-all">
