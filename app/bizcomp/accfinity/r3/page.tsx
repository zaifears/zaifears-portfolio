          ...
          <form onSubmit={(e) => { e.preventDefault(); setIsConfirmed(true); }}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="email" required className="w-full px-3 py-2 rounded-lg border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm" placeholder="hello@shahoriar.bd" />
              </div>
              <div>
