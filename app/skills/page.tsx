...
// --- EXISTING SKILL COMPONENTS (FIXED) ---  
        ...
        <div className="space-y-8 max-w-4xl mx-auto">  
          {certificates.length > 0 ? (  
            certificates.map((cert, index) => (  
              <div key={index} className="bg-neutral-900 p-6 rounded-lg border border-neutral-800 flex flex-col sm:flex-row items-start gap-6">  
                ...
                <div className="flex-grow">  
                  ...
                  {/* --- Display the description as plain text --- */}  
                  {cert.fields.description && (  
                    <p className="text-neutral-300 mt-2 text-sm">  
                      {typeof cert.fields.description === 'string'   
                        ? cert.fields.description   
                        : 'Certificate description available'  
                      }  
                    </p>  
                  )}  
            ...
            <div className="text-center py-8">  
              <p className="text-neutral-400">No certificates available at the moment.</p>  
            </div>  
          )}  
        </div>  
      </div>  
