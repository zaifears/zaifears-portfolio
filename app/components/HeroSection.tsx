...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-12 flex md:flex-row flex-col items-center gap-6 justify-center md:justify-start" initial="visible" animate="visible">
        <LiveTime />
      ...
      <div className="flex flex-col md:flex-row items-center md:items-end gap-8 md:gap-12">
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 rounded-full bg-linear-to-r from-blue-500/20 to-purple-500/20 blur-2xl"
            animate={{ rotate: 360 }}
        ...
        <div className="flex-1 w-full md:w-auto flex flex-col items-center md:items-start text-center md:text-left order-2">
          {/* Main headline */}
          <motion.div variants={itemVariants} initial="visible" animate="visible" className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3 mb-6">
              ...
              <div className="relative h-7 md:h-8 overflow-hidden">
                <motion.div
                  animate={{ y: ["0%", "0%", "-16.66%", "-16.66%", "-33.33%", "-33.33%", "-50%", "-50%", "-66.66%", "-66.66%", "-83.33%", "-83.33%"] }}
                  transition={{ 
                    duration: 12,
                    repeat: Infinity,
                    ease: "easeInOut",
